...
namespace job_shop {
    ...
    public:
        ...
        // 结果矩阵
        Eigen::Matrix<int, 318, 1> result_cur;
    ...
    public:
        ...
        // 添加新的车身
        void AddCar(int row, int car_id, int t);

        // 翻转车身
        void ReverseCar(int car_type, int t);
        ...
        // 记录车身所在位置
        void recorder(std::ofstream &outFile, const int &reciver, const int &deliver, const int &sented,
